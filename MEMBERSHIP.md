...
This document outlines the various responsibilities of contributor roles in the ComplyTime organization. ComplyTime is made up of several projects that are defined as codebases and services with different release cycles, thus the responsibilities for roles are scope to individual projects. Where applicable for ComplyTime overall, contributor status is equal to the highest status that they have on any project.

This document outlines a core number of contributor roles for ComplyTime projects, such as _Member_, _Reviewer_, and _Maintainer_. An _Technical Oversight Committee_ also serves to supervise the overall ComplyTime project and its health. Using transparent criteria, the journey between roles is based on individual participation. Criteria will be reevaluated periodically to ensure that we can meet the needs of each project with the resources available to contribute.

ComplyTime welcomes new contributors. Not all contributors are able to provide sustained contribution, but each contribution is welcome. Established contributors are expected to demonstrate their adherence to the criteria in this document, familiarity with project organization, roles, policies, etc., and technical and/or writing ability. Role-specific expectations, responsibilities, and requirements are explained below.

## Current roles

The following table provides information about the current roles available to the ComplyTime project.

| Role       | Responsibilities                             | Requirements                                                  | Defined by                    |
|------------|----------------------------------------------|---------------------------------------------------------------|-------------------------------|
| Member     | Active contributor in the community          | Multiple contributions and sponsored by 2 Maintainers         | ComplyTime GitHub org member |
| Reviewer    | Reviews issues and PRs                      | History of issue triage and PR review and sponsored by 2 Maintainers           | ComplyTime GitHub Reviewer team member       |
| Maintainer | Sets direction and priorities for a project | Demonstrated responsibility and excellent technical judgement. Nominated and approved by Maintainers team. | ComplyTime GitHub Maintainer team member, [CODEOWNERS](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/about-code-owners), and `MAINTAINERS.md` in each project |
...
Changes to contributor roles must be approved by a vote of the Technical Oversight Committee or a majority of the current project's Maintainers.
